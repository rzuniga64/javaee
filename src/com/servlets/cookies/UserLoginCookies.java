 ...
 *  Pull the parameters userid and password from the session cookie so we can
 *  user is authenticated.
 */
@WebServlet(name = "UserLoginCookies", urlPatterns = {"/userlogincookies.do"})
public class UserLoginCookies extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest request,
        ...
        if (remember) {
            //we also want to store the information in a cookie for reuse later:
